...
@section('content')
    <section class="container">
        ...
        <div class="text-end">
            <a class="btn btn-success" href="{{ route('admin.technologies.create') }}">Crea un nuovo technology</a>
        </div>
                ...
                @foreach ($technologies as $technology)
                    <tr>
                        ...
                        <td><a href="{{ route('admin.technologies.show', $technology->slug) }}"
                                title="View Category">{{ $technology->name }}</a></td>
                        ...
                        <td>
                            <form action="{{ route('admin.technologies.destroy', $technology->slug) }}" method="POST">
                                @csrf
                                @method('DELETE')
                                <button technology="submit" class="delete-button btn btn-danger ms-3"
